...
# Variables
new_cases = df['positiveIncrease'][0]
total_cases = df['positive'][0]
new_tests = df['totalTestResultsIncrease'][0]
total_tests = df['totalTestResults'][0]
new_deaths = df['deathIncrease'][0]
total_deaths = df['death'][0]
last_update = datetime.date(df['date'][0])
        ...
        [
            ...
            dbc.Tabs(
                [
                    ...
                    #dbc.Tab(label="Trends", tab_id="tab-2"),
...
def init_callbacks(dash_app):
    ...
    def render_tab_content(active_tab):
        if active_tab is not None:
            if active_tab == "tab-1":
                ...
                return (html.Br(),
                    dcc.Graph(id='fig_pos_rate', figure=fig_pos_rate),
                    html.Div(
                            [
                                dbc.Button(
                ...
                return (
                    dcc.Graph(id='fig_hos_rate', figure=fig_hos_rate),
                    html.Div(
                            [
                                dbc.Button(
                ...
                return (
                    dcc.Graph(id='fig_dth_rate', figure=fig_dth_rate),
                    html.Div(
                            [
                                dbc.Button(
    ...
    def update_output(value):
        if value == 'PT':
            return dcc.Graph(id='fig_pos_test_in', figure=fig_pos_test_in)
        elif value == 'H':
            return dcc.Graph(id='fig_hos_in', figure=fig_hos_in)
        elif value == 'D':
            return dcc.Graph(id='fig_dth_in', figure=fig_dth_in)
